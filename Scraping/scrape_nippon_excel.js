...
// Nippon Sushi store locations from https://nipponsushi.com.my/location/
const storesData = [
  // Selangor (8 stores)
...
XLSX.utils.book_append_sheet(wb, ws, 'Nippon Sushi Stores');

// Write to file
const outputFile = 'nippon_sushi_locations.xlsx';
XLSX.writeFile(wb, outputFile);

console.log(`✅ Successfully exported ${storesData.length} store locations to ${outputFile}`);
console.log('\nStores by state:');
